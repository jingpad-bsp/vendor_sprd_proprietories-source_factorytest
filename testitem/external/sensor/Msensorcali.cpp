...
static int SENSOR_TYPE = SENSOR_TYPE_MAGNETIC_FIELD;
static int SENSOR_TEST_RESULT = CASE_CALI_MAGSOR;
static char* TEST_TITLE = "Magnetic Sensor";
static char* TEST_MENU = MENU_CALI_MAGSOR;
static char* TEST_TEXT_OPER = MAG_CALI_OPER1;
...
static void *test_msensor_cali_thread (void *)
{
...
int cali_msensor_start_extern(void)
 {
	 ...
	 pthread_t thread,thread_timeout;
       ...
       //work start
       //ret = do_cali_work();
	pthread_create(&thread, NULL, test_msensor_cali_thread, NULL);
	thread_run = 1;
	...
	LOGD("cali_msensor_start_extern test_result=%d",test_result);
	ret = test_result;
       sleep(2);
