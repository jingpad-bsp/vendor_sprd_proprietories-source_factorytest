...
enum {
	...
	MENUTITLE(CASE_TEST_THIRD_CAMERA,TEST_THIRD_CAMERA, test_third_camera_start)
	...
	MENUTITLE(CASE_TEST_LPSOR,TEST_LPSENSOR, test_lsensor_start)
	MENUTITLE(CASE_TEST_LSENSOR,TEST_LSENSOR, test_lsensor_start)
	MENUTITLE(CASE_TEST_PXYPSOR,TEST_PXYSENSOR, test_pxysensor_start)
