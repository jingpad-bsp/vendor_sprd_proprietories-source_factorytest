...
#define MENU_TEST_THIRD_CAMERA			"- 后置三摄像头"
...
#define MENU_TEST_LPSENSOR				"- 光距离传感器"
#define MENU_TEST_LSENSOR				"- 光传感器"
#define MENU_TEST_PXYSENSOR				"- 距离传感器"
...
#define MENU_TEST_FLASHLIGHT			"- 手电筒测试"
...
#define TEXT_LIB_ERROR					"动态库加载失败"
#define TEXT_SYMBOL_ERROR			    "动态库中未找到测试接口"
#define TEXT_PREVIEW_ERROR			    "预览失败"
...
#define TEXT_HD_KEY_TIMES				"耳机按键按下次数:"
#define TEXT_HD_KEY_STATE				"耳机按键按下状态:"
...
#define TEXT_LSENSOR_OPENING					"请将手机水平放置在400lux下,光传感器测试中..."
#define TEXT_PXYSENSOR_OPENING					"距离传感器测试中..."
...
//FINGERSOR
#define FINGERSOR_TEST_TIPS				"请勿触碰指纹检测模组,按“开始”键初始化模组"
#define FINGER_INIT_TIPS				"指纹模组正在初始化..."
#define FINGER_INIT_PASS				"指纹模组初始化完成"
#define FINGER_INIT_FAIL				"指纹模组初始化失败!"
#define FINGERSOR_START_TIPS			"请在10秒内将手指放在指纹传感器上"
...
#define TEL_TEST_START_LTE					"10086拨打中....."
#define TEL_TEST_TIPS					"请注意通话语音"
#define TEL_DIAL_OVER					"已经拨出...."
#define TEL_DIAL_FAIL					"打开协议栈失败,请稍后测试"

//NFC
#define NFC_DRIVER_CHECKING				"正在检测驱动..."
#define NFC_TIPS						"请在30秒内将标签贴近手机NFC天线"
#define NFC_HAL_SCANING					"正在扫描标签..."
#define NFC_TAG_TYPE					"标签类型:"
